...
namespace COFFEE.Controllers
{
    public class IzvjestajController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,DatumIvrijeme,vrstaIzvjestaja")] Izvjestaj izvjestaj)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,DatumIvrijeme,vrstaIzvjestaja")] Izvjestaj izvjestaj)
        {
            if (id != izvjestaj.ID)
            {
                return NotFound();
