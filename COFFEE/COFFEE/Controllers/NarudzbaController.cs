...
namespace COFFEE.Controllers
{
    public class NarudzbaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,UkupnaCijena,DatumIVrijeme,IDKorisnika,StanjeNarudzbe")] Narudzba narudzba)
        {
            ...
            ViewData["IDKorisnika"] = new SelectList(_context.Korisnik, "ID", "ID", narudzba.IDKorisnika);
            return View(narudzba);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,UkupnaCijena,DatumIVrijeme,IDKorisnika,StanjeNarudzbe")] Narudzba narudzba)
        {
            if (id != narudzba.ID)
            {
                return NotFound();
